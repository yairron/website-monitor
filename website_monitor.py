...
if __name__ == "__main__":
    ...
    monitor.send_email_alert(
        ...
        body="""זהו מייל בדיקה מהמערכת שלך.

אם קיבלת מייל זה - המערכת עובדת מצוין! ✅
...
תקבל התראה כשיהיה שינוי באחד מהאתרים האלה.
...
**בדוק את תיבת המייל שלך!** (גם ב-Spam/Junk)

אמור להגיע מייל עם הכותרת:
```
🧪 בדיקת מערכת מעקב - הכל עובד!
